function admtvcPgid() {
    try {
        ...
        if ("undefined" != typeof ADM_CHECKER) return a = ADM_CHECKER.getCookie("__RC"), a = "" != a ? 101 < parseInt(a) ?
            101 : a : a, "&lsn=" + __m_admPageloadid + "&dgid=" + __admloadPageRdIdc + "&l=" + a + "&loc=" + a + "&i=" + ADM_CHECKER.__uid + "&isdetail=" + (b ? "1" : "0")
    } catch (d) {
        return ""
    }
};
    ...
    if ("undefined" != typeof ADS_CHECKER && "undefined" == typeof ADM_CHECKER) {
        ...
        if(dmn.indexOf('vietnamnet.vn')==-1){
                ...
                if(!(-1<na.indexOf("FBAN")||-1<na.indexOf("FBAV"))){
                    if ("" == a || "" == b) ADS_CHECKER.setStorage("_fips", 1, 30, "/"), _admloadJs("https://media1.admicro.vn/ngvmfg/static/js/bundle.js")
                }
            })
        }
...
try{
var getViewablePercentOfEle = function(eleId) {
    ...
    var e = ele.offsetHeight,
        f = ADS_CHECKER.getElementTop(eleId);
